  ...
  return (
    <div id="reviews" className="relative p-4 mb-4">
      <div className="flex justify-center items-center  p-3">
        <button className="mt-24 max-sm:mt-1 mb-4 bg-blue-200 hover:bg-blue-600 px-4 py-1 rounded-2xl text-blue-500 hover:text-white h-8 w-32 font-black text-xs uppercase cursor-pointer ">
          our reviews
        </button>
      </div>
      <div className="relative ">
        <div className="flex flex-col justify-center items-center">
          <p className="text-[90px] max-sm:text-[55px]  text-blue-600 font-black text-center z-0 absolute top-0 left-0 w-full uppercase dark:text-white">
            reviews
          </p>
        </div>
      </div>
      ...
      <div className="relative justify-center items-center">
        <p className="font-medium text-base text-center max-sm:mt-32 mt-60  text-gray-500">
          &quot;A well-designed Blue Real website can be the bridge
      ...
      <div className="flex flex-col sm:flex-row justify-center items-center  mt-[60px] ml-[30px]  ">
        <div className=" flex flex-col mb-5">
          <div className="w-[350px] h-[160px] flex items-start p-[30px] gap-[10px] bg-white  dark:bg-slate-700 shadow-md rounded-[10px] ">
            <p className=" font-semibold text-[13px] leading-[25px] text-gray-500  dark:text-white">
