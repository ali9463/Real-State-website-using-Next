  ...
  return (
    <div id="services" className="relative p-4 mb-4">
      <div className="flex justify-center items-center">
        <button className="relative mt-24 bg-blue-200 max-sm:mt-1 hover:bg-blue-600 px-4 py-1 rounded-2xl text-blue-500 hover:text-white h-8 w-32 font-black text-xs uppercase cursor-pointer ">
          Our services
        </button>
      </div>
      ...
      <div className="relative justify-center items-center">
        <p className="font-medium text-base text-center mt-40 max-sm:mt-32 text-gray-700">
      ...
      <div className="grid grid-cols-2 sm:flex justify-center items-center mt-16 ml-[40px] cursor-pointer">
