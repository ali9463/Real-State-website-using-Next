    ...
    <div id="about-container" className="relative p-4 mb-4">
      ...
      <div className="relative ">
        <div className="flex flex-col justify-center items-center mt-20">
          <p
            className="text-9xl max-sm:text-[55px] text-blue-600  font-black text-center z-0 absolute top-0 left-0 w-full dark:text-white
          "
          >
            About Us
          </p>
      ...
      <div className="relative justify-center items-center">
        <p className="font-medium text-base text-center mt-40 max-sm:mt-32 text-gray-700">
          Blue Real is &quot;property consisting of land and the buildings on
      ...
      <div className="flex flex-col sm:flex-row justify-center items-center mt-[50px] ml-[28px]">
        <div className="bg-white  py-35 px-10 h-[160px] w-[350px] mr-[30px] flex flex-col justify-center items-center rounded-[10px] shadow-lg mb-5 dark:bg-slate-700">
